    ...
    return (
      <>
        <Modal id={this.props.id} show={this.props.show} >
          ...
          <br />
          <Modal.Body>
            {this.props.firstChoice} <Button variant="primary" onClick={this.props.firstChoiceClick}>
              Use This Data
            </Button>
            <br />
            {this.props.secondChoice} <Button variant="primary" onClick={this.props.secondChoiceClick}>
              Use This Data
            </Button>
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" onClick={this.props.mergeChoice}>
              Merge Data
            </Button>
          </Modal.Footer>
        </Modal>
